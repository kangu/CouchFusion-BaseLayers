...
const getClonedDocument = (document: MinimalContentDocument): MinimalContentDocument => {
    ...
    <section class="inline-live-editor__preview">
      <div class="inline-live-editor__preview-frame">
        ...
        <div v-else class="inline-live-editor__preview-placeholder">
          Unable to determine preview URL. Configure `public.siteUrl` or pass `preview-base-url`.
        </div>
      </div>
    </section>
  </div>
