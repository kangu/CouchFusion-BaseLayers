...
import { requireConferenceDocument } from "#events/server/utils/require-conference";
import {
...
export default defineEventHandler(async (event) => {
  ...
  await requireConferenceDocument(conferenceId);
  ...
  const nextPrefs = setConferencePreference(currentPrefs, "watched", conferenceId, true);
